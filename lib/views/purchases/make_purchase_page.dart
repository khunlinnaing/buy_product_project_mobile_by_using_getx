...
import '../../controllers/purchases/make_purchase_controller.dart';

class MakePurchasePage extends StatelessWidget {
  MakePurchasePage({super.key});
  final MakePurchaseController controller = Get.put(MakePurchaseController());
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text("total".tr, style: labelStyle),
              const SizedBox(height: 8),
